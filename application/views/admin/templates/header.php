            ...
            <nav id="sidebar" class="sidebar-wrapper">
                ...
                <div class="sidebarMenuScroll">
                    <ul class="sidebar-menu">
                        <li class="<?=$menu == 'dashboard'?'active current-page':''?> ">
                            <a href="<?=base_url('dashboard');?>">
                                <i class="bi bi-pie-chart"></i>
                                <span class="menu-text">Dashboard</span>
                            </a>
                        </li>
                        <li class="<?=$menu == 'suplemen'?'active current-page':''?>">
                            <a href="<?=base_url('suplemen');?>">
                                <i class="bi bi-basket2"></i>
                                <span class="menu-text">Data Suplemen</span>
                            </a>
                        </li>
                        <li class="<?=$menu == 'kriteria'?'active current-page':''?>">
                            <a href="<?=base_url('kriteria');?>">
                                <i class="bi bi-bookshelf"></i>
                                <span class="menu-text">Kriteria</span>
                            </a>
                        </li>
                        <li class="<?=$menu == 'subkriteria'?'active current-page':''?>">
                            <a href="<?=base_url('subkriteria');?>">
                                <i class="bi bi-check2-square"></i>
                                <span class="menu-text">Sub kriteria</span>
                            </a>
                        </li>
                        <!-- <li class="<?=$menu == 'user'?'active current-page':''?>">
                        ...
                        <div class="dropdown ms-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-end shadow-sm">
                                <div class="p-3 border-bottom mb-2">
                                    <h6 class="mb-1"><?= ucfirst($this->session->userdata('username'));?></h6>
                                </div>
